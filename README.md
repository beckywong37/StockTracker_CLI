Stock Tracker is a command line stock tracking application that allows users to keep track of stocks and stay up to date with real time stock data and news.
